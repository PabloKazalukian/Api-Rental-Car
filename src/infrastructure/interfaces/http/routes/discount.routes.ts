...
router.get('/discount', discountMiddleware.passAuth('jwt', { session: false }), discountMiddleware.checkAdminRole.bind(discountController), (req, res) => { discountController.getAllDiscount(req, res); });
