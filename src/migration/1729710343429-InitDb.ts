...
export class InitDb1729710343429 implements MigrationInterface {
    name = 'InitDb1729710343429'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`discount\` (\`id\` varchar(36) NOT NULL, \`created_ad\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_ad\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`code_discount\` varchar(255) NOT NULL, \`initial_date\` varchar(255) NOT NULL, \`expiration_date\` varchar(255) NOT NULL, \`percentage\` int NOT NULL, \`status\` tinyint NOT NULL, \`request_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
